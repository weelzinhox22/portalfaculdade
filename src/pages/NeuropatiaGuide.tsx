    ...
    <div className="antialiased" style={{ paddingTop: '2rem' }}>
      ...
      <div className="content-wrapper">
        <main className="container mx-auto px-6 py-8">
          ...
          {/* Section: Ferramentas - Link para página separada */}
          <section className="card section-purple mb-4" style={{ textAlign: 'center' }}>
            <h2 className="section-title purple">🚀 Ferramentas de IA para Saúde</h2>
            <p style={{ fontSize: '1.2rem', lineHeight: '1.8', color: '#7c3aed', marginBottom: '2rem', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
              <Link to="/ferramentas-ia" className="modern-button" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center' }}>
